   ...
   <el-header>
    <base-header :simple=true>
          <el-col :span="4" :offset="2">
           ...
           <el-button type="text" icon="el-icon-back" @click="$router.push('/')">返回</el-button>   &nbsp&nbsp&nbsp&nbsp 创&nbsp&nbsp作&nbsp&nbsp文&nbsp&nbsp章
          ...
          <el-col :span="4" :offset="6">
            <div class="me-write-btn">
              ...
              <el-button type ="warning"round @click="cancel">离开</el-button>
  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        // 新增
  reset() {
      this.$confirm('确定要重置内容吗？这将清除所有输入数据。', '重置确认', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
        // 用户点击了“确定”，重置 articleForm
        this.articleForm = {
          id: '',
          title: '',
          summary: '',
        ...
        // 重置编辑器内容
        if (this.articleForm.editor.ref) {
          this.articleForm.editor.ref.codemirror.setValue('');
        }
        this.$message({
          type: 'success',
          message: '内容已重置',
